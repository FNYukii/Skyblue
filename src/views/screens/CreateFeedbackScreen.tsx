			...
			<FormModal className="w-full sm:w-[400px]">
				...
				{!isCreated &&
					<>
						...
						<input autoFocus value={title} onChange={e => setTitle(e.target.value)} placeholder="件名" className="block   mt-6 w-full pb-2   border-b border-gray-300   outline-none focus:border-blue-500   placeholder:text-gray-400" />
