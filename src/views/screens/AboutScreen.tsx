		...
		<Screen title="このアプリについて - Skyblue">
			...
			<div className="flex flex-col gap-8 sm:flex-row sm:gap-8 md:gap-16">
				...
				<div className="grow">
					...
					<p className="text-gray-500">このアプリのソースコードは<a target="blank" href="https://github.com/FNYukii/Skyblue" className="text-black hover:underline">GitHub</a>で確認できます。</p>
					...
					<p className="mt-2 text-gray-500">その他の使用ライブラリは<a target="blank" href="https://github.com/FNYukii/Skyblue" className="text-black hover:underline">ソースコード</a>をご確認ください。</p>
