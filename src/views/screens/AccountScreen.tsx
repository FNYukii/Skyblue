			...
			<div className="flex flex-col gap-8 sm:flex-row sm:gap-8 md:gap-16">
				...
				<div className="grow">
					...
					<div className="mt-8   flex justify-between items-center gap-2   flex-col sm:flex-row sm:gap-8">
						...
						<button onClick={() => alert("この機能は未実装です。")} className="py-2 px-6 border rounded-full font-bold   whitespace-nowrap   hover:bg-gray-100 transition">変更する</button>
					</div>
					...
					<div className="mt-8   flex justify-between items-center gap-2   flex-col sm:flex-row sm:gap-8">
						...
						<button onClick={() => alert("この機能は未実装です。")} className="py-2 px-6 border border-red-200 text-red-500 rounded-full font-bold   whitespace-nowrap   hover:bg-red-50 transition">削除する</button>
					</div>
				</div>
			</div>
		</Screen>
