	...
	return (
		...
		<div className={props.className}>
			...
			{props.images.length === 1 &&
				...
				<img src={window.URL.createObjectURL(props.images[0])} alt="Images for new Spot" className="aspect-square object-cover rounded-lg" />
			}
			...
			{props.images.length === 4 &&
				...
				<div className="grid grid-cols-2 gap-1">
					...
					{props.images.map(image => (
						...
						<img src={window.URL.createObjectURL(image)} alt="Images for new Spot" className="aspect-square object-cover rounded-lg" />
					))}
				</div>
			}
		</div>
